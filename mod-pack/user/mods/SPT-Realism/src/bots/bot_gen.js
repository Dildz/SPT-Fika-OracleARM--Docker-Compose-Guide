...
const BotWeaponGenerator_1 = require("/snapshot/project/obj/generators/BotWeaponGenerator");
const tsyringe_1 = require("/snapshot/project/node_modules/tsyringe");
const utils_1 = require("../utils/utils");
const BotEquipmentModGenerator_1 = require("/snapshot/project/obj/generators/BotEquipmentModGenerator");
const BotGeneratorHelper_1 = require("/snapshot/project/obj/helpers/BotGeneratorHelper");
const BotGenerator_1 = require("/snapshot/project/obj/generators/BotGenerator");
const BotLevelGenerator_1 = require("/snapshot/project/obj/generators/BotLevelGenerator");
const BotInventoryGenerator_1 = require("/snapshot/project/obj/generators/BotInventoryGenerator");
const BaseClasses_1 = require("/snapshot/project/obj/models/enums/BaseClasses");
const arrays_1 = require("../utils/arrays");
const bots_1 = require("./bots");
const EquipmentSlots_1 = require("/snapshot/project/obj/models/enums/EquipmentSlots");
const ModSpawn_1 = require("/snapshot/project/obj/models/enums/ModSpawn");
const ExhaustableArray_1 = require("/snapshot/project/obj/models/spt/server/ExhaustableArray");
const IFilterPlateModsForSlotByLevelResult_1 = require("/snapshot/project/obj/models/spt/bots/IFilterPlateModsForSlotByLevelResult");
const bot_loot_serv_1 = require("./bot_loot_serv");
const GameEditions_1 = require("/snapshot/project/obj/models/enums/GameEditions");
const ItemTpl_1 = require("/snapshot/project/obj/models/enums/ItemTpl");
const MemberCategory_1 = require("/snapshot/project/obj/models/enums/MemberCategory");
