class ATL15_BAR_182
{
    constructor()
    {
        this.modname = "ATLAS_ATL15_BARREL_182";
    ...
    load()
    {
        const itemId = "010421_ATL15_BAR_182_300"; // unique item id, used in tarkov
        ...
        const itemFleaPrice = 19788; // Price of item on Fleamarket

        // item
        const itemPrefabPath = "ATL15_BAR_180.bundle"; // Server/mods/this.modname/bundles/...
        const itemLongName = "182mm Titanium Nitride Barrel for ATL-15 .300 BLK"; // 277mm = ~11"
        const itemShortName = "182mm ATL-15 .300 BLK";
        const itemDescription = "Custom, Atlas 182mm Titanium Nitride Barrel for ATL-15 .300 BLK. Manufactured by A T L A S.";

        // offer
        const itemTrader = "5a7c2eca46aef81a7ca2145d"; // MK
        const itemTraderPrice = 19788;
    ...
    addItemTo(i_id)
    {
        ...
        const itemPropsConflictingItems = [
            ...
            "55f84c3c4bdc2d5f408b4576", // RIS II
            "588b56d02459771481110ae2", // RIS II
            "55d459824bdc2d892f8b4573", // KAC RIS
            "5d00e0cbd7ad1a6c6566a42d", // VIPER
            "5d00f63bd7ad1a59283b1c1e", // VIPER FDE
            "5ae30db85acfc408fb139a05", // COLT
            "5c78f2792e221600106f4683", // MOE SL
            "5c9a26332e2216001219ea70", // RIS FSP
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._id = i_id;
        item._props.Weight = 0.308;
        item._props.Prefab.path = i_path;
        item._props.ExtraSizeLeft = 1;
        item._props.Recoil = -1;
        item._props.Ergonomics = -1;
        item._props.Velocity = -5.3;
        item._props.CenterOfImpact = 0.062; // 1MOA = 0.036
        ...
        item._props.Slots[1]._props.filters[0].Filter = [
            "5d00ec68d7ad1a04a067e5be" // only supports this gas block
        ]
...
module.exports.ATL15_BAR_182 = ATL15_BAR_182;
