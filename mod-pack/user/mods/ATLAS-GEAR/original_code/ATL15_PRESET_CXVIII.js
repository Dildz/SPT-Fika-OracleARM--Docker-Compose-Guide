class ATL15_PRESET_CXVIII
{
    constructor()
    {
        this.modname = "ATLAS_ATL15_PRESET_CXVIII";
    ...
    load()
    {
        ...
        // preset
        const itemPresetID = "010421_ATL15_CXV_PRESET";
        const itemPresetName = "Honey Badger CXVIII"; // not used for base preset, used as presetName (changeWeaponName = true)
        const itemPresetParent = "010421_ATL15_CXV_PARENT";
        const itemPresetPrice = 198686;
    ...
    createWeaponPreset(p_id, p_name, p_parent, i_id)
    {
        ...
        DatabaseServer.tables.globals.ItemPresets[p_id] = {
            ...
            {
                "_id": "ATL15_CXV_PRESET_PGRIP00", // uniqueID for this 
            ...
            {
                "_id": "ATL15_CXV_PRESET_MAG0000", // uniqueID for this
                "_tpl": "55d4887d4bdc2d962f8b4570", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_magazine",
            },
            {
                "_id": "ATL15_CXV_PRESET_UPPER00", // uniqueID for this
                "_tpl": "010421_ATL15_UPPER_BLK00", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_reciever",
            },
            {
                "_id": "ATL15_CXV_PRESET_STOCK00", // uniqueID for this
                "_tpl": "010421_ATL15_STK_M7A1000", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_stock",
            },
            {
                "_id": "ATL15_CXV_PRESET_CHARG00", // uniqueID for this
                "_tpl": "55d44fd14bdc2d962f8b456e", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_charge",
            },
            {
                "_id": "ATL15_CXV_PRESET_BARRL00", // uniqueID for this
                "_tpl": "010421_ATL15_BAR_182_300", //
                "parentId": "ATL15_CXV_PRESET_UPPER00", // parentID for this
                "slotId": "mod_barrel",
            },
            {
                "_id": "ATL15_CXV_PRESET_HANDGRD", // uniqueID for this
                "_tpl": "010421_ATL15_HND_SMR_950", //
                "parentId": "ATL15_CXV_PRESET_UPPER00", // parentID for this
                "slotId": "mod_handguard",
            },
            {
                "_id": "ATL15_CXV_PRESET_MUZZL00", // uniqueID for this
                "_tpl": "5d443f8fa4b93678dd4a01aa", //
                "parentId": "ATL15_CXV_PRESET_BARRL00", // parentID for this
                "slotId": "mod_muzzle",
            },
            {
                "_id": "ATL15_CXV_PRESET_GASBLK0", // uniqueID for this
                "_tpl": "5d00ec68d7ad1a04a067e5be", //
                "parentId": "ATL15_CXV_PRESET_BARRL00", // parentID for this
                "slotId": "mod_gas_block",
            },
            {
                "_id": "ATL15_CXV_PRESET_MUZZL01", // uniqueID for this
                "_tpl": "010421_ATL15_MUZ_HYPR000", //
                "parentId": "ATL15_CXV_PRESET_MUZZL00", // parentID for this
                "slotId": "mod_muzzle",
            }]
        }
    }
...
module.exports.ATL15_PRESET_CXVIII = ATL15_PRESET_CXVIII;
