class ATL_SUIT_X69
{
	constructor()
	{
		this.modname = "ATLAS_CLOTHING_X69";
	...
	load()
	{
		...
		const itemUpperBundle = "ATL_X69_UPPER.bundle"; // CAB- 954660f661d4b748b86a63f62d599794 === 954660f661d4b748b86a63f62a696969
		const itemHandsBundle = "ATL_X69_HANDS.bundle"; // CAB- c5b9410fdad3ada5264e7f83edc63dc2 === c5b9410fdad3ada5264e7f83atl69as8
		const itemLowerBundle = "ATL_X69_LOWER.bundle"; // CAB- a2b4c039581b0b24b97d02e704852cc0 === a2b4c039581b0b24b97d02e698869xx8

		// use unique item id's here
		const itemUpperId = "010421_CLOTHING_X69UPPR0";
		const itemHandsId = "010421_CLOTHING_X69HAND0";
		const itemLowerId = "010421_CLOTHING_X69LOWR0";
		const itemUpperSuitId = "010421_SUIT_UPPR_X69SUIT";
		const itemLowerSuitId = "010421_SUIT_LOWR_X69SUIT";

		// name displayed to player
		const itemUpperName = "ATLAS X69 Upper"; // upper name
		const itemLowerName = "ATLAS X69 Lower"; // lower name
	...
	createItemUpper(i_uid, i_hid, i_ubundle, i_hbundle, i_usuitid, i_uname)
	{
		...
		DatabaseServer.tables.traders["5ac3b934156ae10c4430e83c"].suits.push(
		{
			...
			"requirements":
			{
				...
				"itemRequirements": [
				{
					"count": 69, // money count
					"_tpl": "5696686a4bdc2da3298b456a" // USD Dollars
				}]
			}
		});
	}
...
module.exports.ATL_SUIT_X69 = ATL_SUIT_X69;
