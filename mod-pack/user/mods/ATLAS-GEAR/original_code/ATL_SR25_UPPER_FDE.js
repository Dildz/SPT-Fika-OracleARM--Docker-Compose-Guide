class ATL_SR25_UPPER_FDE
{
    constructor()
    {
        this.modname = "ATLAS_SR25_UPPER_FDE";
    ...
    load()
    {
        ...
        const itemId = "0088_ATL_SR25_UPPER_FDE_8800";
        const itemPrefabPath = "ATL_SR25_UPPER_FDE.bundle";
        const itemClone = "5df8e4080b92095fd441e594";
        const itemCategory = "5b5f764186f77447ec5d7714";
        const itemLongName = "Upper receiver KAC 7.62x51 for SR-25 rifle FDE";
        const itemShortName = "SR-25 Upper";
        const itemDescription = "Custom, Upper receiver for SR-25 rifle manufactured by Knight's Armament Company.";
        const itemFleaPrice = 7074;
        const itemTrader = "5935c25fb3acc3127c3d8cd9";
        const itemTraderPrice = 60;
...
module.exports.ATL_SR25_UPPER_FDE = ATL_SR25_UPPER_FDE;