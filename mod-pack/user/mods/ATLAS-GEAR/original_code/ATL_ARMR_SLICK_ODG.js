class ATL_ARMR_SLICK_ODG
{
    constructor()
    {
        this.modname = "ATLAS_ARMOR_SLICK_OD_GREEN";
    ...
    load()
    {
        ...
        const itemId = "010521_ARMR_SLICK_ODG000";
        const itemPrefabPath = "ATL_ARMR_SLICK_ODG.bundle";
        const itemClone = "5e4abb5086f77406975c9342";
        const itemCategory = "5b5f701386f774093f2ecf0f";
        const itemLongName = "LBT 6094A Slick Plate Carrier ODG";
        const itemShortName = "Slick";
        const itemDescription = "Simple ODG (Olive Drab Green) plate carrier by LBT company. The most minimalistic design intended for use with chest rigs.";
...
module.exports.ATL_ARMR_SLICK_ODG = ATL_ARMR_SLICK_ODG;
