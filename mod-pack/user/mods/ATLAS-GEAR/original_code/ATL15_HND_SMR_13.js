class ATL15_HND_SMR_13
{
    constructor()
    {
        this.modname = "ATLAS_ATL15_SMR13";
    ...
    {
        // main
        const itemId = "010421_ATL15_HND_SMR_130"; // unique item id, used in tarkov
        const itemClone = "5ea16ada09aa976f2e7a51be" // base item, make clone from this

        // handbook
        const itemCategory = "5b5f75e486f77447ec5d7712"; // https://docs.sp-tarkov.com/#resources/items_stats.md -->> Weapon Parts & mod
        const itemFleaPrice = 18088; // Price of item on Fleamarket

        // item
        const itemPrefabPath = "ATL15_SMR13.bundle"; // Server/mods/this.modname/bundles/...
        const itemLongName = "Atlas SMR MK88 13.5in M-LOK Handguard for ATL-15";
        const itemShortName = "ATL SMR 13.5";
        const itemDescription = "Custom, Atlas Superior Modular Rail MK88 13.5in M-LOK Handguard for ATL-15. Manufactured by A T L A S.";

        // offer
        const itemTrader = "5a7c2eca46aef81a7ca2145d"; //
        const itemTraderPrice = 18088;
...
module.exports.ATL15_HND_SMR_13 = ATL15_HND_SMR_13;
