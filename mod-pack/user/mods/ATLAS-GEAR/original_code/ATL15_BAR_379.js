class ATL15_BAR_379
{
    constructor()
    {
        this.modname = "ATLAS_ATL15_BARREL_379";
    ...
    load()
    {
        const itemId = "010421_ATL15_BAR_379_300"; // unique item id, used in tarkov
        const itemClone = "55d3632e4bdc2d972f8b4569" // base item, make clone from this

        // handbook
        const itemCategory = "5b5f75c686f774094242f19f"; // https://docs.sp-tarkov.com/#resources/items_stats.md -->> Weapon Parts & mod
        const itemFleaPrice = 49788; // Price of item on Fleamarket

        // item
        const itemPrefabPath = "ATL15_BAR_379.bundle"; // Server/mods/this.modname/bundles/...
        const itemLongName = "379mm Titanium Nitride Barrel for ATL-15 .300 BLK"; // 379mm = ~15"
        const itemShortName = "379mm ATL-15 .300 BLK";
        const itemDescription = "Custom, Atlas 379mm Titanium Nitride Barrel for ATL-15 .300 BLK. Manufactured by A T L A S.";

        // offer
        const itemTrader = "5a7c2eca46aef81a7ca2145d"; // MK
        const itemTraderPrice = 49788;
    ...
    addItemTo(i_id)
    {
        ...
        const itemPropsConflictingItems = [
            ...
            "5d4405f0a4b9361e6a4e6bd9", // LS ION
            "5df916dfbb49d91fb446d6b9", // URX 14.5"
            "5c78f2612e221600114c9f0d", // SAI 10"
            "5fc235db2770a0045c59c683" // MK18 HG
        ]
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._id = i_id;
        item._props.Weight = 0.508;
        item._props.Prefab.path = i_path;
        item._props.Recoil = -5;
        item._props.Ergonomics = -5;
        item._props.Velocity = -3.1;
        item._props.CenterOfImpact = 0.036; // 1MOA = 0.036
...
module.exports.ATL15_BAR_379 = ATL15_BAR_379;
