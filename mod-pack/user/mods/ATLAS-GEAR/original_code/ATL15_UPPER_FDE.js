class ATL15_UPPER_FDE
{
    constructor()
    {
        this.modname = "ATLAS_ATL15_UPPER_FDE";
    ...
    {
        // main
        const itemId = "010421_ATL15_UPPER_FDE00"; // unique item id, used in tarkov
        ...
        // item
        const itemPrefabPath = "ATL15_UPPER_FDE.bundle"; // Server/mods/this.modname/bundles/...
        const itemLongName = "Atlas 5.56x45 Upper FDE for ATL-15 Precision Rifle";
        const itemShortName = "ATL-15 Upper";
        const itemDescription = "Custom, Atlas 5.56x45 Upper FDE for ATL-15 Precision Rifle. The ATL-15 upper is optimized for lightweight and durability. Manufactured by A T L A S.";
...
module.exports.ATL15_UPPER_FDE = ATL15_UPPER_FDE;
