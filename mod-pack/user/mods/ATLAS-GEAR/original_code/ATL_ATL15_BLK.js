class ATL_ATL15_BLK
{
    ...
    {
        // main
        const itemId = "010421_ATL_WPN_ATL15_BLK"; // unique item id, used in tarkov
        ...
        // item
        const itemPrefabPath = "ATL15_BLK/weapon_container.bundle"; // Server/mods/this.modname/bundles/...
        const itemLongName = "Atlas ATL-15 .300 BLK Precision Rifle";
        const itemShortName = "ATL-15";
        const itemDescription = "Custom, Atlas ATL-15 .300 BLK Precision Rifle. Featuring a custom Titanium Nitride bolt carrier, with JP Enhanced Bolt, POF Roller Cam Pin, and enhanced extractor spring and Trigger Tech Adaptable 3.5lb Two Stage Trigger and Radian Talon Ambi Safety Selector Switch. The ATL-15 is optimized for mid/long range shooting. Manufactured by A T L A S";
        ...
        // preset
        const itemPresetName = "010421_ATL15_BLK_PRESET";
        const itemPresetID = "010421_ATL15_BLK_PRESETID";
        const itemPresetParent = "010421_ATL15_BLK_PARENT";
        const itemPresetPrice = 166809;
        ...
        // CAB EDITS
        // TEX  7d033a2c95aec6ef29ea4769d287373f === 7d033a2c95aec6ef29ea4769a888888t
        // CA   7ddb6c5287cae450e38740dbc18f50b5 === 7ddb6c5287cae450e38740atl88a88s8
        // WPN  1f22fe02d16233506bf133a9975c2aab === 1f22fe02d16233506bf133a8888t8las
    }
    ...
    createItemWeapon(i_clone, i_id, i_path)
    {
        ...
        item._props.Ergonomics = 45; // ERGO
        item._props.RecoilForceUp = 150; // RECOIL ▲ -- ▼
        item._props.RecoilForceBack = 400; // RECOIL ◄ -- ►
        item._props.bFirerate = 650; // weapon rate of fire
        item._props.defAmmo = "5fbe3ffdf8b6a877a729ea82"; // 300BLK default ammo
        item._props.ammoCaliber = "Caliber762x35"; // 300BLK caliber
        item._props.Chambers[0]._props.filters[0].Filter = ["5fbe3ffdf8b6a877a729ea82", "5fd20ff893a8961fc660a954"] // 300BLK ammo

        // add itemID to ConflictingItems
    ...
    createWeaponPreset(p_id, p_name, p_parent, i_id)
    {
        ...
        DatabaseServer.tables.globals.ItemPresets[p_id] = {
            ...
            {
                "_id": "ATL15_BLK_PRESET_PGRIP00", // uniqueID for this
            ...
            {
                "_id": "ATL15_BLK_PRESET_MAG0000", // uniqueID for this
                "_tpl": "5aaa5dfee5b5b000140293d3", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_magazine",
            },
            {
                "_id": "ATL15_BLK_PRESET_UPPER00", // uniqueID for this
                "_tpl": "010421_ATL15_UPPER_BLK00", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_reciever",
            },
            {
                "_id": "ATL15_BLK_PRESET_STOCK00", // uniqueID for this
                "_tpl": "5d120a10d7ad1a4e1026ba85", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_stock",
            },
            {
                "_id": "ATL15_BLK_PRESET_CHARG00", // uniqueID for this
                "_tpl": "56ea7165d2720b6e518b4583", //
                "parentId": p_parent, // parentID for this
                "slotId": "mod_charge",
            },
            {
                "_id": "ATL15_BLK_PRESET_BAR0000", // uniqueID for this
                "_tpl": "010421_ATL15_BAR_277_300", //
                "parentId": "ATL15_BLK_PRESET_UPPER00", // parentID for this
                "slotId": "mod_barrel",
            },
            {
                "_id": "ATL15_BLK_PRESET_HANDG00", // uniqueID for this
                "_tpl": "010421_ATL15_HND_SMR_950", //
                "parentId": "ATL15_BLK_PRESET_UPPER00", // parentID for this
                "slotId": "mod_handguard",
            },
            {
                "_id": "ATL15_BLK_PRESET_REARS00", // uniqueID for this
                "_tpl": "5fb6564947ce63734e3fa1da", //
                "parentId": "ATL15_BLK_PRESET_UPPER00", // parentID for this
                "slotId": "mod_sight_rear",
            },
            {
                "_id": "ATL15_BLK_PRESET_MUZZ000", // uniqueID for this
                "_tpl": "5d026791d7ad1a04a067ea63", //
                "parentId": "ATL15_BLK_PRESET_BAR0000", // parentID for this
                "slotId": "mod_muzzle",
            },
            {
                "_id": "ATL15_BLK_PRESET_GAS0000", // uniqueID for this
                "_tpl": "56eabcd4d2720b66698b4574", //
                "parentId": "ATL15_BLK_PRESET_BAR0000", // parentID for this
                "slotId": "mod_gas_block",
            },
            {
                "_id": "ATL15_BLK_PRESET_FRNTS00", // uniqueID for this
                "_tpl": "5fb6567747ce63734e3fa1dc", //
                "parentId": "ATL15_BLK_PRESET_HANDG00", // parentID for this
...
module.exports.ATL_ATL15_BLK = ATL_ATL15_BLK;
