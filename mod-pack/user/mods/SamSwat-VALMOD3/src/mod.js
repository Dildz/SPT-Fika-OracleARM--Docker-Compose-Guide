...
class SamSWATVALMOD3 {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Developers:    Original Bundles & Animations: SamSwat   	Code Framework: GroovypenguinX`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] "GP Coins or GoldPoints?"`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new SamSWATVALMOD3() };
